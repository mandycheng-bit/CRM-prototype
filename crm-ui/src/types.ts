...
export interface Proposal {
  ...
  renewalRequired?: 'Yes' | 'No'; // Whether this Opportunity should be offered for renewal (feeds the Bulk Renew eligibility filter) — 2026 (Opportunity Pipeline) only
  renewRequired?: 'Yes' | 'No'; // Opportunity-level flag — a 100% Oppty with Renew Required = Yes shows the RENEW button in its header (Terence Lee NB & Renewal Oppty workflow, 2026-09-02) — 2027 (Gmi) only
